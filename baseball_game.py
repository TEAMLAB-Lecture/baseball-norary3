...
def is_between_100_and_999(user_input_number):
    ...
    result = number >= 100 and number < 1000
...
def is_validated_number(user_input_number):
    ...
    # print('is_digit?', is_digit(user_input_number))
...
def get_not_duplicated_three_digit_number():
    ...
    rnd = str(get_random_number())
    while not( is_between_100_and_999(rnd) and not(is_duplicated_number(rnd) ) ) :
